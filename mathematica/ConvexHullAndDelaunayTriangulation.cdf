...
NotebookDataLength[     81813,       1666]
NotebookOptionsPosition[     54499,       1078]
NotebookOutlinePosition[     80765,       1639]
CellTagsIndexPosition[     80654,       1633]
WindowTitle->Convex Hull and Delaunay Triangulation
WindowFrame->Normal*)
...
Cell["Convex Hull and Delaunay Triangulation", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`convshow$$ = True, $CellContext`delshow$$ = 
    True, $CellContext`pts$$ = {{-3, -3}, {2, -2}, {4, 2}, {1, 
    3}}, $CellContext`vorshow$$ = True, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`pts$$], {{-3, -3}, {2, -2}, {4, 2}, {1, 
       3}}}, {-5, -5}, {5, 5}}, {{
       Hold[$CellContext`delshow$$], True, "Delaunay triangulation "}, {
      True, False}}, {{
       Hold[$CellContext`convshow$$], True, "convex hull"}, {True, False}}, {{
       Hold[$CellContext`vorshow$$], True, "Voronoi diagram"}, {
      True, False}}}, Typeset`size$$ = {360., {178., 182.}}, 
    Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`pts$23121$$ = {0, 0}, $CellContext`delshow$23122$$ = 
    False, $CellContext`convshow$23123$$ = 
    False, $CellContext`vorshow$23124$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`convshow$$ = True, $CellContext`delshow$$ = 
        True, $CellContext`pts$$ = {{-3, -3}, {2, -2}, {4, 2}, {1, 
         3}}, $CellContext`vorshow$$ = True}, "ControllerVariables" :> {
        Hold[$CellContext`pts$$, $CellContext`pts$23121$$, {0, 0}], 
        Hold[$CellContext`delshow$$, $CellContext`delshow$23122$$, False], 
        Hold[$CellContext`convshow$$, $CellContext`convshow$23123$$, False], 
        Hold[$CellContext`vorshow$$, $CellContext`vorshow$23124$$, False]}, 
      "OtherVariables" :> {
      ...
      "Body" :> (
       If[Length[$CellContext`pts$$] < 
         3, $CellContext`pts$$ = $CellContext`pts1]; $CellContext`pts1 = \
$CellContext`pts$$; $CellContext`lp = 
        ListPlot[$CellContext`pts$$, PlotRange -> 5, Axes -> True, 
          AspectRatio -> 1]; 
       If[$CellContext`delshow$$, $CellContext`diaglst = \
$CellContext`DelaunayList[$CellContext`pts$$]; $CellContext`diagdel = Table[
            Graphics[{
              Thickness[0.005], Red, 
              Line[
               Part[$CellContext`diaglst, $CellContext`i]]}], {$CellContext`i, 
             Length[$CellContext`diaglst]}], $CellContext`diagdel = {}; Null]; 
       If[$CellContext`convshow$$, $CellContext`cnvlist = \
$CellContext`ConvexHullList[$CellContext`pts$$]; $CellContext`diagcnv = Table[
            Graphics[{
              Thickness[0.005], Blue, 
              Line[
               Part[$CellContext`cnvlist, $CellContext`i]]}], {$CellContext`i, 
             Length[$CellContext`cnvlist]}]; Null, $CellContext`diagcnv = {}; 
         Null]; If[$CellContext`vorshow$$, $CellContext`diagvor = (
           ReplaceAll[#, {
            Line -> $CellContext`MyLine, Point -> $CellContext`MyPoint}]& )[
            
            ComputationalGeometry`DiagramPlot[$CellContext`pts$$, 
             ComputationalGeometry`LabelPoints -> True]]; 
         Null, $CellContext`diagvor = {}]; 
       Show[$CellContext`lp, $CellContext`diagdel, $CellContext`diagcnv, \
$CellContext`diagvor, PlotRange -> 5, AxesOrigin -> {0, 0}]), 
      "Specifications" :> {{{$CellContext`pts$$, {{-3, -3}, {2, -2}, {4, 2}, {
          1, 3}}}, {-5, -5}, {5, 5}, ControlType -> Locator, 
         LocatorAutoCreate -> 
         True}, {{$CellContext`delshow$$, True, "Delaunay triangulation "}, {
         True, False}}, {{$CellContext`convshow$$, True, "convex hull"}, {
         True, False}}, {{$CellContext`vorshow$$, True, "Voronoi diagram"}, {
    ...
    DynamicModuleValues:>{},
    Initialization:>((Needs["ComputationalGeometry`"]; $CellContext`MyLine[
         Pattern[$CellContext`x, 
          Blank[]]] := {Green, 
         Thickness[0.003], 
         Line[$CellContext`x]}; $CellContext`MyPoint[
         Pattern[$CellContext`x, 
          Blank[]]] := {Green, 
         PointSize[0.02], 
         Point[$CellContext`x]}; $CellContext`DelaunayList[
         Pattern[$CellContext`pts, 
          Blank[]]] := 
       Module[{$CellContext`triang, $CellContext`diaglst}, \
$CellContext`triang = 
          ComputationalGeometry`DelaunayTriangulation[$CellContext`pts]; \
$CellContext`diaglst = {}; 
         Do[Do[If[
              Part[$CellContext`triang, $CellContext`i, 1] < 
               Part[$CellContext`triang, $CellContext`i, 2, $CellContext`j], 
               AppendTo[$CellContext`diaglst, {
                 Part[$CellContext`pts, 
                  Part[$CellContext`triang, $CellContext`i, 1]], 
                 Part[$CellContext`pts, 
                  
                  Part[$CellContext`triang, $CellContext`i, 
                   2, $CellContext`j]]}]]; Null, {$CellContext`j, 
              Length[
               Part[$CellContext`triang, $CellContext`i, 2]]}]; 
           Null, {$CellContext`i, 
            Length[$CellContext`triang]}]; Return[$CellContext`diaglst]; 
         Null]; $CellContext`ConvexHullList[
         Pattern[$CellContext`pts, 
          Blank[]]] := 
       Module[{$CellContext`cnvhull}, $CellContext`cnvhull = 
          Map[Part[$CellContext`pts, #]& , 
            ComputationalGeometry`ConvexHull[$CellContext`pts]]; Return[
           Append[
            Table[{
              Part[$CellContext`cnvhull, $CellContext`i], 
              
              Part[$CellContext`cnvhull, $CellContext`i + 
               1]}, {$CellContext`i, Length[$CellContext`cnvhull] - 1}], {
             First[$CellContext`cnvhull], 
             Last[$CellContext`cnvhull]}]]; 
         Null]; $CellContext`pts1 = {{-3, -3}, {2, -2}, {4, 2}, {1, 3}}; 
...
Cell["\<\
For three or more points, you can see the convex hull (blue), the Delaunay \
triangulation (red), or the Voronoi diagram (green). \
\>", "ManipulateCaption"],
...
Cell[TextData[{
 ...
 " are points, then the convex hull is always a polygon whose vertices are a \
subset of ",
 Cell[BoxData[
  FormBox["S", TraditionalForm]], "InlineMath"],
 ".  "
...
Cell[TextData[{
 ...
 ". In the graph theory sense, the Voronoi diagram is the dual graph of the \
...
Cell[TextData[{
 ButtonBox["Delaunay Triangulation",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/DelaunayTriangulation.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Convex Hull",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/ConvexHull.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
ConvexHullAndDelaunayTriangulation&version=0008"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/ConvexHullAndDelaunayTriangulation/\
ConvexHullAndDelaunayTriangulation-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Convex Hull and Delaunay Triangulation",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ConvexHullAndDelaunayTriangulation/\
"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/ConvexHullAndDelaunayTriangulation/"],
 "\"",
...
ConvexHullAndDelaunayTriangulation/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ConvexHullAndDelaunayTriangulation/\
"], None},
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Marko Petkovic",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Marko+Petkovic"]\
, None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Marko+Petkovic"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[41583, 725, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[41844, 734, 1751, 42, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[53677, 1053, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 80367, 1622},
 {"Copyright", 80562, 1627}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34995, 592, 6415, 126, 70, "Output",
 CellID->26850789],
Cell[41413, 720, 167, 3, 70, "ManipulateCaption"],
Cell[41583, 725, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41844, 734, 1751, 42, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43598, 778, 33, 0, 70, "DetailsSection"],
Cell[43634, 780, 846, 28, 70, "DetailNotes",
 CellID->221725783],
Cell[44483, 810, 499, 15, 70, "DetailNotes",
 CellID->51941283],
Cell[44985, 827, 811, 24, 70, "DetailNotes",
 CellID->353817128],
Cell[45799, 853, 44, 0, 70, "RelatedLinksSection"],
Cell[45846, 855, 583, 20, 70, "RelatedLinks",
 CellID->238602090],
Cell[46432, 877, 568, 20, 70, "RelatedLinks",
 CellID->17143095],
Cell[47003, 899, 561, 20, 70, "RelatedLinks",
 CellID->124914986],
Cell[47567, 921, 4841, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[52411, 1012, 45, 0, 70, "CitationSection"],
Cell[52459, 1014, 885, 25, 70, "Citations"],
Cell[53347, 1041, 327, 10, 70, "Author"],
Cell[53677, 1053, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature CRUxIygO#7qXEvm7bHeVYXHz *)
